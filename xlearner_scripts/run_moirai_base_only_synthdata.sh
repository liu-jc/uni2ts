...
set -e
#echo $PYTHONPATH
#export PATH=/export/home/juncheng-liu/uni2ts/venv-new-hf/bin:$PATH
#export PYTHONPATH=/export/home/juncheng-liu/uni2ts/venv-new-hf/
#echo $PYTHONPATH
cd /export/lotsa-data/jcliu
pwd
. venv/bin/activate
cd /export/home/juncheng-liu/uni2ts
pwd
#. /export/home/uni2ts/venv-new-hf/bin/activate
which python
which pip
pip install wandb
