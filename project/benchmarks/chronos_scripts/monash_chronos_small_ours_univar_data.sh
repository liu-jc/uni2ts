model_size=small
model_path=/export/home/chronos-forecasting/checkpoints/chronos-${model_size}_arrow_univar_data
...
do
  python run_chronos.py --model_path=${model_path} --dataset=${ds}  --run_name=chronos-${model_size}_arrow_univar_data
done