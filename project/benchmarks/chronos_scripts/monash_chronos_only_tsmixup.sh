...
model_path=/export/home/chronos-forecasting/checkpoints/chronos-${model_size}_only_tsmixup
...
for ds in kaggle_web_traffic_without_missing vehicle_trips_without_missing temperature_rain_without_missing sunspot_without_missing rideshare_without_missing kdd_cup_2018_without_missing
do
  python run_chronos.py --model_path=${model_path} --dataset=${ds}  --run_name=chronos-${model_size}_only_tsmixup
done
