...
model_path=/export/home/chronos-forecasting/checkpoints/chronos-${model_size}_only_synthdata
...
do
  python run_chronos.py --model_path=${model_path} --dataset=${ds}  --run_name=chronos-${model_size}_only_synthdata
done
